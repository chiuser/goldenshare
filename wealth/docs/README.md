...
- [财势乾坤交易助手标杆需求 v1（v1.42；计划及独立提醒价格统一为前复权，保留已确认交互）](./pages/trading-assistant/trading-assistant-benchmark-requirement-v1.md)
- [财势乾坤交易助手技术实施方案 v1（修订 74；计划及独立提醒采用前复权，含可复用 LLD；外部接入及真实验收未放行）](./pages/trading-assistant/trading-assistant-implementation-design-v1.md)
