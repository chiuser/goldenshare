...
- [财势乾坤交易助手标杆需求 v1（v1.23；佣金与印花税均自动计算，账户改费率不回算旧交易；正式 Figma 已同步待复核）](./pages/trading-assistant/trading-assistant-benchmark-requirement-v1.md)
- [财势乾坤交易助手技术实施方案 v1（草稿修订 17；两项税费统一版本与生效规则，补配置审计和验收清单；整体未完成，未编码）](./pages/trading-assistant/trading-assistant-implementation-design-v1.md)
