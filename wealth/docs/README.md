...
- [财势乾坤交易助手标杆需求 v1（v1.29；R9 已通过并正式合入，范围复盘与整轮查看节点已对齐；日历及算法不变）](./pages/trading-assistant/trading-assistant-benchmark-requirement-v1.md)
- [财势乾坤交易助手技术实施方案 v1（草稿修订 31；已补范围复盘、整轮查询及正式状态合同，下一步核验规则维护与未覆盖操作状态；整体仍未完成，未编码）](./pages/trading-assistant/trading-assistant-implementation-design-v1.md)
...
- [我的自选分组能力产品需求文档 v2（修订 v2.9；已部署，用户初步验证符合预期）](./pages/watchlist/watchlist-grouping-product-requirement-v2.md)
- [我的自选分组能力交互设计 v2（修订 v2.8；用户初步验证符合预期，最终交互验收由用户负责）](./pages/watchlist/watchlist-grouping-interaction-design-v2.md)
- [我的自选分组能力技术实施方案 v2（修订 v2.8；已部署，部署后只读核验正常）](./pages/watchlist/watchlist-grouping-implementation-design-v2.md)
- [我的自选分组能力低层设计 v2（修订 v2.7，第 25 节记录部署后只读核验与初步验证反馈）](./pages/watchlist/watchlist-grouping-low-level-design-v2.md)
- [我的自选产品与交互基准 v1（当前单列表及历史验收基线；分组目标见 v2）](./pages/watchlist/watchlist-benchmark-requirement-v1.md)
- [我的自选技术实施方案 v1（开发自测完成；未部署、未正式验收）](./pages/watchlist/watchlist-implementation-design-v1.md)
- [我的自选低层设计 v1（含开发对账与测试证据；未部署、未正式验收）](./pages/watchlist/watchlist-low-level-design-v1.md)
