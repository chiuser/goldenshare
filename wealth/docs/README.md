...
- [财势乾坤交易助手标杆需求 v1（v1.49；停牌沿用价的一期判定已明确，税费与期初口径不变）](./pages/trading-assistant/trading-assistant-benchmark-requirement-v1.md)
- [财势乾坤交易助手技术实施方案 v1（修订 128；M4.4 本地实现与验收完成，待独立 Review，未进入 M5）](./pages/trading-assistant/trading-assistant-implementation-design-v1.md)
