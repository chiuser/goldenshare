...
- [我的自选分组能力技术实施方案 v2（修订 v2.6，前端开发自测完成；未部署）](./pages/watchlist/watchlist-grouping-implementation-design-v2.md)
- [我的自选分组能力低层设计 v2（修订 v2.5，第 22～23 节记录后端及前端实现、测试和未执行项）](./pages/watchlist/watchlist-grouping-low-level-design-v2.md)
