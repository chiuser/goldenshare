...
- [财势探查｜板块分析技术实施方案 v1（动量排名已验收；双动量 M6 后端已收口，下一步 M7）](./pages/wealth-exploration/sector-analysis-implementation-design-v1.md)
- [财势探查｜板块分析低层设计 v1（双动量 M6 后端已收口，下一步 M7 前端）](./pages/wealth-exploration/sector-analysis-low-level-design-v1.md)
...
- [新闻速览、新闻通讯与阅读器技术实施方案 v2（已确认，待开发）](./pages/market-overview/market-news-implementation-design-v1.md)
- [新闻弹窗阅读器视觉与安全基线 v2（现有阅读器已验收）](./pages/market-overview/market-news-reader-implementation-design-v1.md)
- [新闻速览、新闻通讯与阅读器低层设计 v2（代码级方案）](./pages/market-overview/market-news-reader-low-level-design-v1.md)
