...
- [财势乾坤交易助手标杆需求 v1（v1.33；R11 保存结果确认与恢复已通过并应用正式稿；日历及算法不变）](./pages/trading-assistant/trading-assistant-benchmark-requirement-v1.md)
- [财势乾坤交易助手技术实施方案 v1（草稿修订 39；补保存确定性、恢复及登录重发边界；整体未完成，未编码）](./pages/trading-assistant/trading-assistant-implementation-design-v1.md)
