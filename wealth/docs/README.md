...
- [财势乾坤交易助手标杆需求 v1（v1.37；R12 已通过并合入正式页，既有业务口径不变）](./pages/trading-assistant/trading-assistant-benchmark-requirement-v1.md)
- [财势乾坤交易助手技术实施方案 v1（草稿修订 52；R12 字段映射已补，旧系统状态冲突已修正；整体未完成，未编码）](./pages/trading-assistant/trading-assistant-implementation-design-v1.md)
