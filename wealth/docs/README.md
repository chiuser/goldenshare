...
- [财势乾坤交易助手标杆需求 v1（v1.41；闭环详情、交易备注及费用示例已对齐正式 Figma）](./pages/trading-assistant/trading-assistant-benchmark-requirement-v1.md)
- [财势乾坤交易助手技术实施方案 v1（修订 73；补齐闭环字段与三项审计修正，含可复用 LLD；外部接入及真实验收未放行）](./pages/trading-assistant/trading-assistant-implementation-design-v1.md)
