...
- [财势乾坤交易助手标杆需求 v1（v1.15，期间收益、成本分母、资金复用及日历当天收益已确认；Figma 语义与技术方案待同步）](./pages/trading-assistant/trading-assistant-benchmark-requirement-v1.md)
...
- [我的自选分组能力产品需求文档 v2（已确认；前后端已实现，待交互验收）](./pages/watchlist/watchlist-grouping-product-requirement-v2.md)
- [我的自选分组能力交互设计 v2（已评审；前端已实现，未执行交互验收）](./pages/watchlist/watchlist-grouping-interaction-design-v2.md)
- [我的自选分组能力技术实施方案 v2（修订 v2.7，前后端已提交；部署与交互验收由用户负责）](./pages/watchlist/watchlist-grouping-implementation-design-v2.md)
- [我的自选分组能力低层设计 v2（修订 v2.6，第 24 节记录真实接口联调与技术验证）](./pages/watchlist/watchlist-grouping-low-level-design-v2.md)
