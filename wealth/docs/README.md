...
- [财势乾坤交易助手标杆需求 v1（v1.48；新交易与当前预计卖出用当前费率，历史不追溯修改，期初建仓日上界已确认，R14 已合入正式稿）](./pages/trading-assistant/trading-assistant-benchmark-requirement-v1.md)
- [财势乾坤交易助手技术实施方案 v1（修订 97；M3 一致读取、当前卖出估算及计算状态 API）](./pages/trading-assistant/trading-assistant-implementation-design-v1.md)
