...
- [财势乾坤交易助手标杆需求 v1（v1.50；机器人关键词最多 10 个，超限保留输入并提示）](./pages/trading-assistant/trading-assistant-benchmark-requirement-v1.md)
- [财势乾坤交易助手技术实施方案 v1（修订 136；M7 配置存储与恢复定位已提交，原测试结果读取接线）](./pages/trading-assistant/trading-assistant-implementation-design-v1.md)
