...
- [我的自选分组能力产品需求文档 v2（已确认；后端已实现，前端未开发）](./pages/watchlist/watchlist-grouping-product-requirement-v2.md)
- [我的自选分组能力交互设计 v2（已评审；前端未开发）](./pages/watchlist/watchlist-grouping-interaction-design-v2.md)
- [我的自选分组能力技术实施方案 v2（修订 v2.5，后端已实现；待阶段验收、未部署）](./pages/watchlist/watchlist-grouping-implementation-design-v2.md)
- [我的自选分组能力低层设计 v2（修订 v2.4，第 22 节记录后端实现、测试和未执行项）](./pages/watchlist/watchlist-grouping-low-level-design-v2.md)
