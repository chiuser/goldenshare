...
- [财势乾坤交易助手标杆需求 v1（v1.38；成交数量按正整数登记，不限整手；R12 已合入正式页）](./pages/trading-assistant/trading-assistant-benchmark-requirement-v1.md)
- [财势乾坤交易助手技术实施方案 v1（草稿修订 56；成交数量边界已确认；整体未完成，未编码）](./pages/trading-assistant/trading-assistant-implementation-design-v1.md)
