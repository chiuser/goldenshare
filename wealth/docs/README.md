...
- [财势乾坤交易助手标杆需求 v1（v1.39；停牌估值口径已确认；R13-A 已合入正式状态稿）](./pages/trading-assistant/trading-assistant-benchmark-requirement-v1.md)
- [财势乾坤交易助手技术实施方案 v1（整体评审稿修订 68；补齐读取上下文、分页与精确核算函数；编码前证据见 §11.5，未放行全量开发）](./pages/trading-assistant/trading-assistant-implementation-design-v1.md)
