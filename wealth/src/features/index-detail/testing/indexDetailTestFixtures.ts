...
export function makePageInit(tsCode = "000001.SH"): IndexDetailPageInitResponseDto {
  return {
    ...
    quote: { tradeDate: "2026-07-31", point: 3940.04, change: 39.69, changePct: 1.02, direction: "UP", open: 3943.82, high: 3967.59, low: 3938.63, preClose: 3900.35, vol: 542_000_000, volDisplay: "5.42万", amount: 117_000_000 },
...
export function makeKline(tsCode = "000001.SH"): IndexDetailKlineResponseDto {
  ...
  return {
    ...
    bars: ["2026-07-30", "2026-07-31"].map((tradeDate, index) => ({
      tradeDate, open: 3900 + index * 20, high: 3960 + index * 5, low: 3880 + index * 10, close: 3930 + index * 10, preClose: 3890 + index * 10, change: 40, changePct: 1.02, amplitude: 1.42, vol: 500_000_000, volDisplay: "5.00万", amount: 110_000_000,
