...
BEFORE_WINDOW = datetime(2026, 5, 29, 19, 14, tzinfo=ZoneInfo("Asia/Shanghai"))
...
class StkMinsSilverM6GSensorContractTests(unittest.TestCase):
    def test_decision_skips_before_window_and_without_partition(self) -> None:
        ...
        self.assertIn("19:15", before_window.reason)
    ...
    def test_cursor_contract_for_selected_silver_run(self) -> None:
        ...
        self.assertEqual(STOCK_MINS_SILVER_RUN_START.isoformat(), "19:15:00")
        for fragment in (
            "status_samples",
            "to_cursor_details",
            "readiness_details",
