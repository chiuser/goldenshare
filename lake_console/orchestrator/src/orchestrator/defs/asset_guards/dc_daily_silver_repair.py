...
The normal Silver asset has no repair producer yet.  This adapter is the
source-specific contract entry future repair code must use before a Gold
repair sensor can be added.  It only builds/parses bounded in-memory metadata;
it does not create a Dagster definition or inspect event history.
"""
