"""Register index_mins partitions and backfill verified Dagster events."""
...
from orchestrator.defs.bootstrap.index_mins_bootstrap_events import (
...
DEFAULT_RECONCILIATION_REPORT = Path(
    "/private/tmp/index_mins_bootstrap_apply_20260730/index_mins_bootstrap_final_20260730_212459.json"
)
...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.command == "register-partitions":
        report = register_index_mins_partitions(
            instance=instance,
        ...
        report = report_index_mins_events(
            instance=instance,
            lake_root=args.lake_root,
            reconciliation_report_path=args.reconciliation_report,
            duckdb_resource=DuckDBResource(),
