...
def main(argv: list[str] | None = None) -> None:
    ...
    _add_gold_qfq_history_selection(plan_gold_qfq_macd_kdj)
    ...
    _add_gold_qfq_history_selection(audit_gold_qfq_macd_kdj_files)
    ...
    _add_gold_qfq_history_selection(report_gold_qfq_macd_kdj_baseline_events)
    report_gold_qfq_macd_kdj_baseline_events.add_argument(
        "--dry-run",
        action="store_true",
    )
    ...
    _add_gold_qfq_history_selection(audit_gold_qfq_macd_kdj_final)
    ...
    elif args.command == "plan-gold-stk-mins-qfq-macd-kdj-history":
