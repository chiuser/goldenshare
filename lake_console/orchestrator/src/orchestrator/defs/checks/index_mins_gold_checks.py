"""Partitioned blocking checks for ordinary-index Gold minute bars."""
...
GOLD_INDEX_MINS_CHECK_DEFS = tuple(
...
(
    gold_index_mins_1m_core_check,
    gold_index_mins_5m_core_check,
    gold_index_mins_15m_core_check,
    gold_index_mins_30m_core_check,
    gold_index_mins_60m_core_check,
    gold_index_mins_90m_core_check,
    gold_index_mins_120m_core_check,
) = GOLD_INDEX_MINS_CHECK_DEFS

__all__ = ["GOLD_INDEX_MINS_CHECK_DEFS"]
