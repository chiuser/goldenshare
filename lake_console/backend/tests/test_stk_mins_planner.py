...
def test_stk_mins_plan_uses_lifecycle_filtered_security_universe(tmp_path) -> None:
    ...
    assert plan.estimate["symbol_count"] == 2
    assert plan.estimate["security_universe"] == {
        "total_symbols": 4,
        "selected_symbols": 2,
