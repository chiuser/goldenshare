...
PROD_RAW_DB_ALLOWED_TABLES = {
    ...
    "namechange": "raw_tushare.namechange",
    "st": "raw_tushare.st",
    ...
    "stock_company": "raw_tushare.stock_company",
...
PROD_RAW_DB_ORDER_BY = {
    ...
    "namechange": ("ts_code", "start_date", "ann_date"),
    "st": ("ts_code", "imp_date", "pub_date"),
