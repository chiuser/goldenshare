...
- M6D 仍需补录 `silver_adj_factor` 的 runless materialization 与 silver blocking check events，否则 Dagster UI/readiness 仍无法识别 silver 文件事实。
