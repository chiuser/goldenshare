...
状态：2026-08-28 M0 历史基线；2026-09-05 旧湖批量分类见 §21，M1 已提交见 §22，M2A 已提交 `0cc84004` 见 §23，M2B 已提交 `e8e2abf9` 见 §24；M3 已提交 `1b0deb63` 见 §25，M4 字段边界已确认、待实施见 §26，其余具体删除待确认
...
## 26. 2026-09-05 M4 开工核验（字段边界已确认，待实施）
...
- [ ] 按 LLD §6.4 先实施恢复工具重构并通过隔离回归，再清退 generic old-lake adapter；当前尚未编码或删除。
- [x] 本轮只更新两份 AGENTS、专项方案、LLD 与本清单；其它任务文件不纳入，无代码/数据删除，无提交/部署。
