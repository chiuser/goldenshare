...
状态：2026-08-28 M0 历史基线；2026-09-05 旧湖批量分类见 §21，M1 已提交见 §22，M2A 已提交 `0cc84004` 见 §23，M2B 已提交 `e8e2abf9` 见 §24；M3 已提交 `1b0deb63` 见 §25，M4 已提交 `68f97744` 见 §26，M5 已提交 `3ed4c6ca` 见 §27，M6 已提交 `63be03af` 见 §28，M7 首轮历史见 §29、续轮技术验收通过见 §30，用户已要求按 11 文件白名单提交；其余具体数据删除待确认
...
- [x] 用户已要求提交 M7；本次按 11 文件白名单归档，提交前重新核 staged diff，提交结果以 Git 记录为准。不推送、不进入 M8，物理数据删除仍须确认具体清单。
