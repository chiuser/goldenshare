...
状态：2026-08-28 M0 历史基线；2026-09-05 旧湖批量分类见 §21，M1 已提交见 §22，M2A 已提交 `0cc84004` 见 §23，M2B 已提交 `e8e2abf9` 见 §24；M3 已提交 `1b0deb63` 见 §25，M4 已提交 `68f97744` 见 §26，M5 文档清退已实施并通过校验、随本次提交归档见 §27，其余具体数据删除待确认
