...
状态：P0 冻结与只读 preflight、P1 共享合同和三条正式写入链路修复已完成；未进入 P2/P3，未重建正式 Lake，未写 Dagster event/DB，未启动或修改 sensor。
...
6. 不在本文阶段执行正式 Lake 重建或 runless event 补录。
