...
const toneMap: Record<string, { background: string; color: string; border: string }> = {
  ...
  success: { background: "rgba(76, 201, 240, 0.14)", color: "#0f6d95", border: "rgba(76, 201, 240, 0.24)" },
  ...
  fresh: { background: "rgba(76, 201, 240, 0.14)", color: "#0f6d95", border: "rgba(76, 201, 240, 0.24)" },
  lagging: { background: "rgba(72, 149, 239, 0.12)", color: "#4361ee", border: "rgba(72, 149, 239, 0.18)" },
  stale: { background: "rgba(247, 37, 133, 0.12)", color: "#b5179e", border: "rgba(247, 37, 133, 0.18)" },
  unknown: { background: "rgba(58, 12, 163, 0.08)", color: "#5c617f", border: "rgba(58, 12, 163, 0.12)" },
