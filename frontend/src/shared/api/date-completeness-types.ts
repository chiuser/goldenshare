export interface DateCompletenessRuleItem {
  ...
  audit_scope: "date_bucket" | "date_subject_matrix";
...
export interface DateSubjectCompletenessGapItem {
  id: number;
  run_id: number;
  dataset_key: string;
  bucket_kind: string;
  bucket_value: string;
  subject_kind: string;
  subject_key_fields: string[];
  actual_key_fields: string[];
  missing_cell_count: number;
  affected_subject_count: number;
  sample_subjects: Record<string, unknown>[];
  created_at: string;
}

export interface DateSubjectCompletenessGapListResponse {
  total: number;
  items: DateSubjectCompletenessGapItem[];
}

export interface DateSubjectCompletenessGapDetailItem {
  id: number;
  run_id: number;
  gap_id: number;
  dataset_key: string;
  ...
  subject_key_json: Record<string, unknown>;
  actual_key_json: Record<string, unknown>;
  lifecycle_start: string | null;
...
export interface DateSubjectCompletenessGapDetailListResponse {
  total: number;
  items: DateSubjectCompletenessGapDetailItem[];
}
