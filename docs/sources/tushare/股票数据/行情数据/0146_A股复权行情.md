...
title: "A股复权行情"
doc_id: 146
source_url: "https://tushare.pro/document/2?doc_id=146"
menu_title: "复权行情"
category_path: ["股票数据", "行情数据"]
scraped_at: "2026-04-19 22:59:11"
api_name: "pro_bar"
---
...
- 分类：股票数据 / 行情数据
- 原始链接：[https://tushare.pro/document/2?doc_id=146](https://tushare.pro/document/2?doc_id=146)

- 接口：pro_bar
- 描述：复权行情通过[通用行情接口](https://tushare.pro/document/2?doc_id=109)实现，利用Tushare Pro提供的[复权因子](https://tushare.pro/document/2?doc_id=28)进行动态计算，因此http方式无法调取。若需要静态复权行情（支持http），请访问[股票技术因子接口](https://tushare.pro/document/2?doc_id=328)。
