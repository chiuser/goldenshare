...
title: "实时成交数据(爬虫版)"
doc_id: 316
source_url: "https://tushare.pro/document/2?doc_id=316"
menu_title: "实时成交（爬虫）"
...
- 分类：股票数据 / 行情数据
- 原始链接：[https://tushare.pro/document/2?doc_id=316](https://tushare.pro/document/2?doc_id=316)
...
| 名称 | 类型 | 必选 | 描述 |
| --- | --- | --- | --- |
| ts_code | str | N | 股票代码，需按tushare[股票代码标准](https://tushare.pro/document/2?doc_id=14)输入，比如：000001.SZ表示平安银行，600000.SH表示浦发银行，单次只能输入一个股票 |
