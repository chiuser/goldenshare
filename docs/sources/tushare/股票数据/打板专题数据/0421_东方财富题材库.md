...
title: "东方财富题材库"
doc_id: 421
source_url: "https://tushare.pro/document/2?doc_id=421"
menu_title: "题材数据（东方财富）"
...
- 分类：股票数据 / 打板专题数据
- 原始链接：[https://tushare.pro/document/2?doc_id=421](https://tushare.pro/document/2?doc_id=421)
