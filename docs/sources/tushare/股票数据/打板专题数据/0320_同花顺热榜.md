...
title: "同花顺热榜"
doc_id: 320
source_url: "https://tushare.pro/document/2?doc_id=320"
menu_title: "同花顺App热榜数"
...
- 分类：股票数据 / 打板专题数据
- 原始链接：[https://tushare.pro/document/2?doc_id=320](https://tushare.pro/document/2?doc_id=320)
...
![页面附图](https://tushare.pro/files/web/ths1.jpg)

![页面附图](https://tushare.pro/files/web/ths2.png)

![页面附图](https://tushare.pro/files/web/ths3.png)
