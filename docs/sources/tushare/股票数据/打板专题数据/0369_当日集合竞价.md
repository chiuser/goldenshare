...
title: "当日集合竞价"
doc_id: 369
source_url: "https://tushare.pro/document/2?doc_id=369"
menu_title: "开盘竞价成交（当日）"
...
- 分类：股票数据 / 打板专题数据
- 原始链接：[https://tushare.pro/document/2?doc_id=369](https://tushare.pro/document/2?doc_id=369)
