...
doc_id: 344
source_url: "https://tushare.pro/document/2?doc_id=344"
menu_title: "板块资金流向（DC）"
...
- 分类：股票数据 / 资金流向数据
- 原始链接：[https://tushare.pro/document/2?doc_id=344](https://tushare.pro/document/2?doc_id=344)
