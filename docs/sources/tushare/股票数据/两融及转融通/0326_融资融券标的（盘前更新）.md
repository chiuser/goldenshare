...
title: "融资融券标的（盘前更新）"
doc_id: 326
source_url: "https://tushare.pro/document/2?doc_id=326"
menu_title: "融资融券标的（盘前）"
category_path: ["股票数据", "两融及转融通"]
scraped_at: "2026-04-20 09:37:26"
...
- 分类：股票数据 / 两融及转融通
- 原始链接：[https://tushare.pro/document/2?doc_id=326](https://tushare.pro/document/2?doc_id=326)
