...
title: "期货Tick行情数据"
doc_id: 314
source_url: "https://tushare.pro/document/2?doc_id=314"
menu_title: "历史Tick行情"
category_path: ["期货数据"]
scraped_at: "2026-04-30 16:12:56"
---

# 期货Tick行情数据

- 分类：期货数据
- 原始链接：[https://tushare.pro/document/2?doc_id=314](https://tushare.pro/document/2?doc_id=314)
...
![页面附图](https://tushare.pro/files/web/ft_tick.png)
