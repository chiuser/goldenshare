...
title: "中信行业指数行情"
doc_id: 308
source_url: "https://tushare.pro/document/2?doc_id=308"
menu_title: "中信行业指数日行情"
category_path: ["指数专题"]
...
- 分类：指数专题
- 原始链接：[https://tushare.pro/document/2?doc_id=308](https://tushare.pro/document/2?doc_id=308)
