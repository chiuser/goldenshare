...
title: "申万行业日线行情"
doc_id: 327
source_url: "https://tushare.pro/document/2?doc_id=327"
menu_title: "申万行业指数日行情"
category_path: ["指数专题"]
...
- 分类：指数专题
- 原始链接：[https://tushare.pro/document/2?doc_id=327](https://tushare.pro/document/2?doc_id=327)
