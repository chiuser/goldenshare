...
title: "因子列表"
doc_id: 486
source_url: "https://tushare.pro/document/2?doc_id=486"
category_path: ["量化因子库"]
...
- 分类：量化因子库
- 原始链接：[https://tushare.pro/document/2?doc_id=486](https://tushare.pro/document/2?doc_id=486)

- 接口：factor_list
- 描述：提取`Tushare自主研发`生产的因子列表，包括因子名、因子分类和计算逻辑等信息
- 限量：单次可以提取所有列表，无需循环提取
- 权限：因子库为单独权限接口，对个人用户2000元一年，机构用户2万元一年，请在“[权限中心](https://tushare.pro/weborder/#/permission)”勾选`因子库`开通。
