...
title: "场内基金技术因子(专业版)"
doc_id: 359
source_url: "https://tushare.pro/document/2?doc_id=359"
menu_title: "基金技术面因子(专业版)"
category_path: ["公募基金"]
...
- 分类：公募基金
- 原始链接：[https://tushare.pro/document/2?doc_id=359](https://tushare.pro/document/2?doc_id=359)
...
无业务参数时，当前源端返回“`ts_code,trade_date` 至少填写一个”，与页面将输入均标为可选的表述不一致。显式请求全部 90 个输出字段时，`trade_date=20260617` 返回 2,021 行、每行均含 90 列；`trade_date` 与 `trade_date_doris` 分别为 `YYYYMMDD` 与 `YYYY-MM-DD` 的同一日期。全市场样本行数为：2015-06-17 205、2018-06-15 344、2022-06-17 1,016、2024-06-17 1,322、2026-06-17 2,021。单代码 `510300.SH` 未传日期时返回 3,448 行，范围为 2012-05-28 至 2026-08-04。
