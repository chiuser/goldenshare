...
- [本地 DG 停牌历史确认事实持久化与统一消费技术方案 v1（文件CLI已实现，事件侧待完成，尚未正式发布）](/Users/congming/github/goldenshare/lake_console/docs/design/dagster-stock-suspend-confirmed-facts-technical-plan-v1.md)
- [本地 DG 停牌历史确认事实持久化与统一消费 LLD v1（§18.25：文件CLI 62例＋既有回归100例通过）](/Users/congming/github/goldenshare/lake_console/docs/design/dagster-stock-suspend-confirmed-facts-low-level-design-v1.md#s1-confirmed-file-bootstrap)
