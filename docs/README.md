...
- [本地 DG 停牌历史确认事实持久化与统一消费技术方案 v1（SQL核心小样本通过；下一步writer与公开SQL同轮切换）](/Users/congming/github/goldenshare/lake_console/docs/design/dagster-stock-suspend-confirmed-facts-technical-plan-v1.md)
- [本地 DG 停牌历史确认事实持久化与统一消费 LLD v1（§18.20：42例SQL/边界测试通过，writer未切换）](/Users/congming/github/goldenshare/lake_console/docs/design/dagster-stock-suspend-confirmed-facts-low-level-design-v1.md#s1-confirmed-sql-core-acceptance)
