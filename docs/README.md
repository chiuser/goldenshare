...
- [本地 DG 停牌历史确认事实持久化与统一消费技术方案 v1（I01复验、I02原生IO通过；其余隔离与S1待验收，专项环境完成后清理）](/Users/congming/github/goldenshare/lake_console/docs/design/dagster-stock-suspend-confirmed-facts-technical-plan-v1.md)
- [本地 DG 停牌历史确认事实持久化与统一消费 LLD v1（§18.12最小属性权限修订实证；I01与I02共42项拒绝均有正向对照）](/Users/congming/github/goldenshare/lake_console/docs/design/dagster-stock-suspend-confirmed-facts-low-level-design-v1.md#s1-isolation-parent-metadata-retest)
