...
- [本地 DG 停牌历史确认事实持久化与统一消费技术方案 v1（I01–I07已通过；I08与业务验收未完成）](/Users/congming/github/goldenshare/lake_console/docs/design/dagster-stock-suspend-confirmed-facts-technical-plan-v1.md)
- [本地 DG 停牌历史确认事实持久化与统一消费 LLD v1（§18.17：I07启动/导入期十五项及原四十六例回归通过，权限不变）](/Users/congming/github/goldenshare/lake_console/docs/design/dagster-stock-suspend-confirmed-facts-low-level-design-v1.md#s1-isolation-i07-startup-collection)
