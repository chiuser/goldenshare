...
- [本地 DG 停牌历史确认事实持久化与统一消费技术方案 v1（五CLI已实现，待剩余消费者/治理回归，尚未正式发布）](/Users/congming/github/goldenshare/lake_console/docs/design/dagster-stock-suspend-confirmed-facts-technical-plan-v1.md)
- [本地 DG 停牌历史确认事实持久化与统一消费 LLD v1（§18.26：文件/事件与实例104例隔离验收通过）](/Users/congming/github/goldenshare/lake_console/docs/design/dagster-stock-suspend-confirmed-facts-low-level-design-v1.md#s1-confirmed-event-bootstrap)
