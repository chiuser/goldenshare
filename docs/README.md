...
- [ETF 基础信息重建与下游数据审计清理技术方案 v1（业务口径已确认 / M0-M8 已完成代码 / 未执行生产重建与删表）](/Users/congming/github/goldenshare/docs/architecture/etf-basic-rebuild-and-downstream-data-audit-cleanup-plan-v1.md)
- [ETF 基础信息重建与下游数据审计清理 LLD v1（新版 P0-P8 已完成代码 / 生产 drop 与重建未执行）](/Users/congming/github/goldenshare/docs/architecture/etf-basic-rebuild-and-downstream-data-audit-cleanup-low-level-design-v1.md)
