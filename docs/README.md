...
- [本地 DG 停牌历史确认事实持久化与统一消费技术方案 v1（集成已提交、受限连接通过，人工CLI待实现，尚未正式发布）](/Users/congming/github/goldenshare/lake_console/docs/design/dagster-stock-suspend-confirmed-facts-technical-plan-v1.md)
- [本地 DG 停牌历史确认事实持久化与统一消费 LLD v1（§18.24：显式受限连接27例通过，原239处调用不变）](/Users/congming/github/goldenshare/lake_console/docs/design/dagster-stock-suspend-confirmed-facts-low-level-design-v1.md#s1-confirmed-restricted-connection)
