...
- [本地 DG 停牌历史确认事实持久化与统一消费技术方案 v1（writer/SQL同步切换，尚未正式发布）](/Users/congming/github/goldenshare/lake_console/docs/design/dagster-stock-suspend-confirmed-facts-technical-plan-v1.md)
- [本地 DG 停牌历史确认事实持久化与统一消费 LLD v1（§18.21：58例临时writer＋42例SQL通过；下一步job/readiness集成）](/Users/congming/github/goldenshare/lake_console/docs/design/dagster-stock-suspend-confirmed-facts-low-level-design-v1.md#s1-confirmed-writer-acceptance)
