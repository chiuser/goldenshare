...
- [实时行情流维护说明（合并两份 HTML；公共链路、股票日线/分钟与历史验收）](/Users/congming/github/goldenshare/docs/architecture/realtime-market-data-stream-technical-plan-v1.md)
...
- [股票当日分时按需方案（未开发；配置合同待拍板、补充时段待验证）](/Users/congming/github/goldenshare/docs/architecture/realtime-stock-intraday-minutes-on-demand-plan-v1.md)
- [ETF 实时日线维护说明（源范围与 Basic 资格分开；历史启用记录保留）](/Users/congming/github/goldenshare/docs/architecture/realtime-etf-daily-stream-plan-v1.md)
- [ETF 实时分钟方案与重入约束（合并撤销 LLD；范围未重新基线，不可开工）](/Users/congming/github/goldenshare/docs/architecture/realtime-etf-minute-stream-plan-v1.md)
...
- [前端技术选型历史决策（保留取舍，不作为新建工程指令）](/Users/congming/github/goldenshare/docs/frontend/frontend-technology-and-component-selection.md)
- [前端当前强约束（统一基线）](/Users/congming/github/goldenshare/docs/frontend/frontend-current-standards.md)
...
- [生产 PostgreSQL 存储治理 v2（一期12项已结案；Track A及独立TODO不自动结案）](/Users/congming/github/goldenshare/docs/governance/prod-postgresql-storage-space-optimization-program-v2.md)
- [生产 PostgreSQL raw 直出一期 LLD（12项生产切换及自然M3b均已结案，历史证据截至2026-08-31）](/Users/congming/github/goldenshare/docs/governance/prod-postgresql-raw-direct-serving-phase-one-lld-v1.md)
...
- [单股缠论五年回测方案 v1（蔚蓝锂芯30分钟前复权策略回测已完成；按股数分批买卖）](/Users/congming/github/goldenshare/docs/product/stock-chan-share-position-backtest-plan-v1.md)
- [指数及缠论旧实验归档（历史结论、教学案例与四组压缩证据）](/Users/congming/github/goldenshare/reports/index_market_history_20260913/README.md)
- [指数窗口个股缠论研究 v1（历史；首批回放及提速完成，已暂停扩批并转向独立单股回测）](/Users/congming/github/goldenshare/docs/product/stock-chan-index-window-research-plan-v1.md)
