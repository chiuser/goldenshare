...
- [本地 DG 停牌历史确认事实持久化与统一消费技术方案 v1（S0–S2完成，真实候选与3,083日期比较通过；尚未正式发布）](/Users/congming/github/goldenshare/lake_console/docs/design/dagster-stock-suspend-confirmed-facts-technical-plan-v1.md)
- [本地 DG 停牌历史确认事实持久化与统一消费 LLD v1（§18.28：S2冻结plan/hash、年度零差异及S3发布边界；S1总对账保留§18.27）](/Users/congming/github/goldenshare/lake_console/docs/design/dagster-stock-suspend-confirmed-facts-low-level-design-v1.md#s2-real-candidate-reconciliation)
