...
- [本地 DG 停牌历史确认事实持久化与统一消费技术方案 v1（S1完成，待S2真实候选/全范围对账；尚未正式发布）](/Users/congming/github/goldenshare/lake_console/docs/design/dagster-stock-suspend-confirmed-facts-technical-plan-v1.md)
- [本地 DG 停牌历史确认事实持久化与统一消费 LLD v1（§18.27：S1总对账、消费者/治理回归及剩余发布边界）](/Users/congming/github/goldenshare/lake_console/docs/design/dagster-stock-suspend-confirmed-facts-low-level-design-v1.md#s1-total-reconciliation)
