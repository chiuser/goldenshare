...
- [财势量化平台（QTF）首版低层设计 v1（待评审，尚未编码）](/Users/congming/github/goldenshare/docs/architecture/qtf-quant-platform-low-level-design-v1.md)
...
- [股票历史分钟行情 tablespace 冷热分层执行记录 v1（历史快照）](/Users/congming/github/goldenshare/docs/ops/stk-mins-tablespace-layout-v1.md)
...
- [ETF 实时成交额异动监控方案 v1（本地实现完成，待部署验收）](/Users/congming/github/goldenshare/docs/ops/ops-etf-realtime-volume-anomaly-monitor-plan-v1.md)
- [ETF 实时成交额异动监控 LLD v1（本地实现完成，待部署验收）](/Users/congming/github/goldenshare/docs/ops/ops-etf-realtime-volume-anomaly-monitor-lld-v1.md)
