...
- [ETF 基础信息重建与下游数据审计清理技术方案 v1（M0-M10 已完成 / 已通过发布门禁 / 生产重建与删表未执行）](/Users/congming/github/goldenshare/docs/architecture/etf-basic-rebuild-and-downstream-data-audit-cleanup-plan-v1.md)
- [ETF 基础信息重建与下游数据审计清理 LLD v1（P0-P10 已完成 / 下一阶段为独立授权的 P11 生产维护窗口）](/Users/congming/github/goldenshare/docs/architecture/etf-basic-rebuild-and-downstream-data-audit-cleanup-low-level-design-v1.md)
...
- [ETF 激活池历史设计与退场记录 v1（P3-P8 代码退场完成 / 生产物理表待 P11）](/Users/congming/github/goldenshare/docs/architecture/etf-active-pool-design-plan-v1.md)
- [ETF 激活池历史 LLD 与退场实现记录 v1（旧基础设施已删除 / drop migration 已准备）](/Users/congming/github/goldenshare/docs/architecture/etf-active-pool-low-level-design-v1.md)
