...
- [ETF 基础信息重建与下游数据审计清理技术方案 v1（业务口径已全部确认 / 请求驱动与激活池替代映射已审计 / 尚未实施）](/Users/congming/github/goldenshare/docs/architecture/etf-basic-rebuild-and-downstream-data-audit-cleanup-plan-v1.md)
- [ETF 基础信息重建与下游数据审计清理 LLD v1（低层设计已完成 / 待评审 / 尚未编码与生产执行）](/Users/congming/github/goldenshare/docs/architecture/etf-basic-rebuild-and-downstream-data-audit-cleanup-low-level-design-v1.md)
