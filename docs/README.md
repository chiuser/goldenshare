...
- [本地 DG 停牌历史确认事实持久化与统一消费技术方案 v1（I01启动预检通过；I02–I08与S1仍待验收）](/Users/congming/github/goldenshare/lake_console/docs/design/dagster-stock-suspend-confirmed-facts-technical-plan-v1.md)
- [本地 DG 停牌历史确认事实持久化与统一消费 LLD v1（§18.9 I01正向与11类拒绝实证；下一步I02原生IO验证）](/Users/congming/github/goldenshare/lake_console/docs/design/dagster-stock-suspend-confirmed-facts-low-level-design-v1.md#s1-isolation-i01-passed)
