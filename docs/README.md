...
- [本地 DG 停牌历史确认事实持久化与统一消费技术方案 v1（六项审计口径已修订；S1 与隔离仍未验收）](/Users/congming/github/goldenshare/lake_console/docs/design/dagster-stock-suspend-confirmed-facts-technical-plan-v1.md)
- [本地 DG 停牌历史确认事实持久化与统一消费 LLD v1（§14.1 六项修订对账；完整测试资源矩阵与 S2 生产合同门禁）](/Users/congming/github/goldenshare/lake_console/docs/design/dagster-stock-suspend-confirmed-facts-low-level-design-v1.md#audit-fixes-20260907)
