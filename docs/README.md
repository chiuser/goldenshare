...
- [本地 DG 停牌历史确认事实持久化与统一消费技术方案 v1（S1 部分实现未验收；安全修正先 review，再隔离验收）](/Users/congming/github/goldenshare/lake_console/docs/design/dagster-stock-suspend-confirmed-facts-technical-plan-v1.md)
- [本地 DG 停牌历史确认事实持久化与统一消费 LLD v1（§18 安全实施细节待 review；未恢复代码修改或测试）](/Users/congming/github/goldenshare/lake_console/docs/design/dagster-stock-suspend-confirmed-facts-low-level-design-v1.md#s1-test-isolation-repair)
