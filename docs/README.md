...
- [本地 DG 停牌历史确认事实持久化与统一消费技术方案 v1（S0–S4完成；S5旧文件已删，回归因测试运行器收尾错误停止）](/Users/congming/github/goldenshare/lake_console/docs/design/dagster-stock-suspend-confirmed-facts-technical-plan-v1.md)
- [本地 DG 停牌历史确认事实持久化与统一消费 LLD v1（§18.34：删除结果、测试收尾错误与剩余清理）](/Users/congming/github/goldenshare/lake_console/docs/design/dagster-stock-suspend-confirmed-facts-low-level-design-v1.md#s5-runner-exit-review)
