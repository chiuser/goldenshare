...
- [本地 DG 停牌历史确认事实持久化与统一消费技术方案 v1（job/readiness集成通过，人工CLI待实现，尚未正式发布）](/Users/congming/github/goldenshare/lake_console/docs/design/dagster-stock-suspend-confirmed-facts-technical-plan-v1.md)
- [本地 DG 停牌历史确认事实持久化与统一消费 LLD v1（§18.23：实际作业/检查与sensor集成，53例＋5subtests通过）](/Users/congming/github/goldenshare/lake_console/docs/design/dagster-stock-suspend-confirmed-facts-low-level-design-v1.md#s1-confirmed-integration-acceptance)
