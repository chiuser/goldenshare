...
- [本地 DG 停牌历史确认事实持久化与统一消费技术方案 v1（I01–I03已通过；其余隔离与业务验收未完成）](/Users/congming/github/goldenshare/lake_console/docs/design/dagster-stock-suspend-confirmed-facts-technical-plan-v1.md)
- [本地 DG 停牌历史确认事实持久化与统一消费 LLD v1（§18.13 D：获批精确读取修订后，I03八例全部通过）](/Users/congming/github/goldenshare/lake_console/docs/design/dagster-stock-suspend-confirmed-facts-low-level-design-v1.md#s1-isolation-i03-real-resource)
