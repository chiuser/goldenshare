...
> 历史文档（归档）：本文用于记录执行解耦过程。当前实现以 [current-architecture-baseline.md](/Users/congming/github/goldenshare/docs/architecture/current-architecture-baseline.md) 与现行代码为准。
