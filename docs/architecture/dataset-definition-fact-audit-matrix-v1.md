...
| `index_daily`<br/>指数日线行情 | index_fund<br/>指数 / ETF | `tushare.index_daily` | trade_open_day/every_open_day/trade_date_or_start_end | ts_code(string) | `core_serving.index_daily_serving` | universe=index_active_codes; enum=-; pagination=offset_limit; max_units=- |
