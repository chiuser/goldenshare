...
1. 数据分层与写入方式遵守 [Foundation 研发基线 §3](/Users/congming/github/goldenshare/docs/architecture/foundation-current-standards.md#3-foundation-分层与数据路径)；不再从旧上手指南继承 pipeline mode 分类。
