...
- do not expose raw internal terms such as `execution`, internal route keys, scheduler internals, or underscored status values as primary UI copy unless they are clearly explained
