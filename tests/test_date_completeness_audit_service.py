...
def test_expected_bucket_planner_builds_calendar_friday_and_month_end_buckets() -> None:
    planner = ExpectedBucketPlanner()
    ...
    assert [bucket.value for bucket in monthly] == [date(2026, 4, 30), date(2026, 5, 31)]
