...
def test_monthly_window_current_month_policy_computes_natural_month_end_trigger() -> None:
    next_run = compute_next_run_at(
        schedule_type="cron",
        timezone_name="Asia/Shanghai",
        cron_expr="0 19 * * *",
...
def test_monthly_window_current_month_preview_returns_month_ends() -> None:
    runs = preview_schedule_runs(
        schedule_type="cron",
        timezone_name="Asia/Shanghai",
        cron_expr="30 18 * * *",
