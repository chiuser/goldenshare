...
def test_dataset_definition_projects_stock_auction_facts() -> None:
    ...
    assert open_definition.storage.core_dao_name == "raw_stk_auction_o"
    assert open_definition.storage.target_table == "raw_tushare.stk_auction_o"
    assert open_definition.storage.delivery_mode == "raw_with_serving_view"
    assert open_definition.storage.layer_plan == "raw->serving_view"
    assert open_definition.storage.write_path == "raw_only_upsert"
    assert open_definition.storage.serving_table == "core_serving.equity_auction_open"
