...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("csname", sa.String(length=64)),
        sa.Column("extname", sa.String(length=128)),
        ...
        sa.Column("mgr_name", sa.String(length=64)),
        sa.Column("custod_name", sa.String(length=64)),
        sa.Column("mgt_fee", sa.Numeric(10, 4)),
        sa.Column("etf_type", sa.String(length=32)),
