...
class _DividendHashDAO(BaseDAO[ModelT], Generic[ModelT]):
...
class RawDividendDAO(_DividendHashDAO[RawDividend]):
    def __init__(self, session) -> None:  # type: ignore[no-untyped-def]
        super().__init__(session, RawDividend)


class EquityDividendDAO(_DividendHashDAO[EquityDividend]):
    def __init__(self, session) -> None:  # type: ignore[no-untyped-def]
        super().__init__(session, EquityDividend)
