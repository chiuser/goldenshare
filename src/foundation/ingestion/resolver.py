    ...
    def build_plan(self, request: DatasetActionRequest) -> DatasetExecutionPlan:
        ...
        return DatasetExecutionPlan(
            ...
            writing=PlanWriting(
                ...
                replacement_scope_fields=definition.storage.replacement_scope_fields,
            ),
            quality=PlanQuality(
                reject_policy=definition.quality.reject_policy,
                empty_result_policy=definition.quality.empty_result_policy,
                pre_write_validator_key=definition.quality.pre_write_validator_key,
            ),
