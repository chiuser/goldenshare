...
if len(FINA_INDICATOR_SOURCE_FIELDS) != 167:
    raise RuntimeError("财务指标源字段契约必须固定为 167 个字段")
if len(FINA_INDICATOR_DECIMAL_FIELDS) != 163:
    raise RuntimeError("财务指标数值字段契约必须固定为 163 个字段")
