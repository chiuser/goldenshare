...
class RawEtfIndex(Base):
    ...
    bp: Mapped[float | None] = mapped_column(Numeric(12, 6))
    adj_circle: Mapped[str | None] = mapped_column(String(64))
    api_name: Mapped[str] = mapped_column(String(32), nullable=False, server_default=text("'etf_index'"))
