...
class RawMoneyflowDc(Base):
    __tablename__ = "moneyflow_dc"
    __table_args__ = (
        Index("idx_raw_tushare_moneyflow_dc_trade_date", "trade_date"),
        Index(
    ...
    api_name: Mapped[str] = mapped_column(String(32), nullable=False, server_default=text("'moneyflow_dc'"))
