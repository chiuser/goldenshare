...
class RawStkAuctionO(Base):
    __tablename__ = "stk_auction_o"
    __table_args__ = (
        Index("idx_raw_tushare_stk_auction_o_trade_date", "trade_date"),
        {"schema": "raw_tushare"},
    )
    ...
    api_name: Mapped[str] = mapped_column(String(32), nullable=False, server_default=text("'stk_auction_o'"))
