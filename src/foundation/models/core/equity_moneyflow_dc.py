...
class EquityMoneyflowDc(TimestampMixin, Base):
    __tablename__ = "equity_moneyflow_dc"
    __table_args__ = (
        Index("idx_equity_moneyflow_dc_trade_date", "trade_date"),
        Index("idx_equity_moneyflow_dc_ts_code_trade_date", "ts_code", "trade_date"),
        {"schema": "core_serving"},
    )
