...
class StkPeriodBarStd(TimestampMixin, Base):
    __tablename__ = "stk_period_bar_std"
    __table_args__ = (
        Index("idx_stk_period_bar_std_freq_trade_date", "freq", "trade_date"),
        Index("idx_stk_period_bar_std_source_freq_trade_date", "source_key", "freq", "trade_date"),
        {"schema": "core_multi"},
    )
