...
class IndicatorKdjStd(TimestampMixin, Base):
    __tablename__ = "indicator_kdj_std"
    __table_args__ = (
        Index("idx_indicator_kdj_std_trade_date", "trade_date"),
        Index("idx_indicator_kdj_std_source_trade_date", "source_key", "trade_date"),
        {"schema": "core_multi"},
    )
