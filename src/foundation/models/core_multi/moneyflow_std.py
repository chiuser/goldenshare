...
class MoneyflowStd(TimestampMixin, Base):
    __tablename__ = "moneyflow_std"
    __table_args__ = (
        Index("idx_moneyflow_std_trade_date", "trade_date"),
        Index("idx_moneyflow_std_source_trade_date", "source_key", "trade_date"),
        {"schema": "core_multi"},
    )
