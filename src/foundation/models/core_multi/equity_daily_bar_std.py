...
class EquityDailyBarStd(TimestampMixin, Base):
    __tablename__ = "equity_daily_bar_std"
    __table_args__ = (
        Index("idx_equity_daily_bar_std_trade_date", "trade_date"),
        Index("idx_equity_daily_bar_std_source_trade_date", "source_key", "trade_date"),
        {"schema": "core_multi"},
    )
