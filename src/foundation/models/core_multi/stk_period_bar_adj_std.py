...
class StkPeriodBarAdjStd(TimestampMixin, Base):
    __tablename__ = "stk_period_bar_adj_std"
    __table_args__ = (
        Index("idx_stk_period_bar_adj_std_freq_trade_date", "freq", "trade_date"),
        Index("idx_stk_period_bar_adj_std_source_freq_trade_date", "source_key", "freq", "trade_date"),
        {"schema": "core_multi"},
    )
