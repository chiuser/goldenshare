...
class RawTushareEquityDailyBar(Base):
    ...
    change_amount: Mapped[float | None] = mapped_column(Numeric(18, 4))
    ...
    api_name: Mapped[str] = mapped_column(String(32), nullable=False, server_default=text("'daily'"))
