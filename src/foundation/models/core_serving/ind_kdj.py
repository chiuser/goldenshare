...
class IndicatorKdj(TimestampMixin, Base):
    __tablename__ = "ind_kdj"
    __table_args__ = (
        Index("idx_ind_kdj_trade_date", "trade_date"),
        Index("idx_ind_kdj_adj_trade_date", "adjustment", "trade_date"),
        {"schema": "core"},
    )
