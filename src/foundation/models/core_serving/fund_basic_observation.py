...
class FundBasicObservation(TimestampMixin, Base):
    __tablename__ = "fund_basic_observation"
    __table_args__ = (
        Index("idx_fund_basic_observation_entity_last_observed", "source_entity_key", desc("last_observed_at")),
        {"schema": "core_serving"},
    )
