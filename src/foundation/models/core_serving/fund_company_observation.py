...
from sqlalchemy import DateTime, Index, Numeric, String, Text, desc
from sqlalchemy.orm import Mapped, mapped_column

from src.foundation.models.base import Base, TimestampMixin


class FundCompanyObservation(TimestampMixin, Base):
    __tablename__ = "fund_company_observation"
    __table_args__ = (
        Index("idx_fund_company_observation_entity_last_observed", "source_entity_key", desc("last_observed_at")),
        {"schema": "core_serving"},
    )
