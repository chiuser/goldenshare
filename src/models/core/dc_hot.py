...
class DcHot(TimestampMixin, Base):
    __tablename__ = "dc_hot"
    __table_args__ = (
        Index("idx_dc_hot_trade_date", "trade_date"),
        Index("idx_dc_hot_data_type_trade_date", "data_type", "trade_date"),
        Index("idx_dc_hot_ts_code_trade_date", "ts_code", "trade_date"),
        {"schema": "core"},
    )
    ...
    query_hot_type: Mapped[str] = mapped_column(String(32), primary_key=True)
