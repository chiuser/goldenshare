...
from src.biz.queries.wealth.market.streak_ladder.streak_ladder_query_service import StreakLadderQueryService
from src.biz.schemas.wealth.market.streak_ladder import StreakLadderResponseDto


router = APIRouter(prefix="/wealth/market", tags=["wealth-market"])


@router.get("/streak-ladder", response_model=StreakLadderResponseDto)
def get_market_streak_ladder(
    ...
    try:
        return StreakLadderQueryService().build_streak_ladder(
            session,
