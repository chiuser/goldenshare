...
class MajorIndicesTradingDayContext:
    market: str
...
@dataclass(frozen=True, slots=True)
class MajorIndicesSourceState:
    observed_trade_date: date | None


class MajorIndicesStateQuery:
    ...
    def resolve_trading_day(
        ...
        *,
        ...
        return MajorIndicesTradingDayContext(
            market=market,
    ...
    def load_source_state(
        ...
        *,
        ...
        return MajorIndicesSourceState(observed_trade_date=observed_trade_date)
