...
from sqlalchemy import BigInteger, Date, DateTime, ForeignKey, Index, Integer, JSON, String, func
from sqlalchemy.orm import Mapped, mapped_column

from src.foundation.models.base import Base


class DatasetDateCompletenessGap(Base):
    __tablename__ = "dataset_date_completeness_gap"
    __table_args__ = (
        Index("idx_dataset_date_completeness_gap_run", "run_id", "id"),
        Index("idx_dataset_date_completeness_gap_dataset_range", "dataset_key", "range_start", "range_end"),
        {"schema": "ops"},
    )
