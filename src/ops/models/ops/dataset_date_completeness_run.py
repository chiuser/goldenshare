...
class DatasetDateCompletenessRun(TimestampMixin, Base):
    ...
    __table_args__ = (
        CheckConstraint("run_mode IN ('manual', 'scheduled')", name="ck_dataset_date_completeness_run_mode_allowed"),
        CheckConstraint(
        ...
        CheckConstraint(
            ...
            name="ck_dataset_date_completeness_audit_scope_allowed",
        ),
        CheckConstraint("start_date <= end_date", name="ck_dataset_date_completeness_run_range_valid"),
        CheckConstraint("expected_bucket_count >= 0", name="ck_dataset_date_completeness_expected_non_negative"),
        CheckConstraint("actual_bucket_count >= 0", name="ck_dataset_date_completeness_actual_non_negative"),
        CheckConstraint("missing_bucket_count >= 0", name="ck_dataset_date_completeness_missing_non_negative"),
        CheckConstraint("excluded_bucket_count >= 0", name="ck_dataset_date_completeness_excluded_non_negative"),
        CheckConstraint("gap_range_count >= 0", name="ck_dataset_date_completeness_gap_range_non_negative"),
        CheckConstraint("expected_cell_count >= 0", name="ck_dataset_date_completeness_expected_cell_non_negative"),
        CheckConstraint("actual_cell_count >= 0", name="ck_dataset_date_completeness_actual_cell_non_negative"),
