...
OPS_DATASET_DEFAULT_VIEW = DatasetCatalogView(
    ...
    groups=(
        ...
        DatasetCatalogGroup("board_theme", "板块 / 题材", 4),
        DatasetCatalogGroup("leader_board", "榜单", 5),
        DatasetCatalogGroup("limit_board", "涨跌停榜", 6),
        DatasetCatalogGroup("index_market_data", "A股指数行情", 7),
        DatasetCatalogGroup("etf_fund", "ETF基金", 8),
        DatasetCatalogGroup("public_fund", "公募基金", 9),
        DatasetCatalogGroup("moneyflow", "资金流向", 10),
        DatasetCatalogGroup("broker_recommendation", "券商推荐", 11),
        DatasetCatalogGroup("news", "新闻资讯", 12),
        DatasetCatalogGroup("hk_reference_data", "港股基础数据", 13),
        DatasetCatalogGroup("us_reference_data", "美股基础数据", 14),
        DatasetCatalogGroup("technical_indicators", "技术指标", 15),
    ),
    items=(
        ...
        DatasetCatalogItem("stock_company", "reference_data", 18),
        ...
        DatasetCatalogItem("income", "equity_financial", 30),
        DatasetCatalogItem("balancesheet", "equity_financial", 40),
        DatasetCatalogItem("cashflow", "equity_financial", 50),
        ...
        DatasetCatalogItem("index_classify", "board_theme", 80),
        DatasetCatalogItem("index_member_all", "board_theme", 90),
        DatasetCatalogItem("sw_daily", "board_theme", 100),
        ...
        DatasetCatalogItem("etf_share_size", "etf_fund", 50),
        DatasetCatalogItem("etf_sz_cons", "etf_fund", 60),
        DatasetCatalogItem("etf_mins", "etf_fund", 70),
        DatasetCatalogItem("fund_company", "public_fund", 10),
        DatasetCatalogItem("mkt_idx_bmk", "public_fund", 20),
        DatasetCatalogItem("fund_basic", "public_fund", 30),
        ...
        DatasetCatalogItem("anns_d", "news", 40),
        DatasetCatalogItem("irm_qa_sh", "news", 50),
        DatasetCatalogItem("irm_qa_sz", "news", 60),
