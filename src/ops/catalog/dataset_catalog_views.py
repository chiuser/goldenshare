...
OPS_DATASET_DEFAULT_VIEW = DatasetCatalogView(
    ...
    groups=(
        ...
        DatasetCatalogGroup("public_fund", "公募基金", 8),
        DatasetCatalogGroup("moneyflow", "资金流向", 9),
        DatasetCatalogGroup("broker_recommendation", "券商推荐", 10),
        DatasetCatalogGroup("news", "新闻资讯", 11),
        DatasetCatalogGroup("hk_reference_data", "港股基础数据", 12),
        DatasetCatalogGroup("us_reference_data", "美股基础数据", 13),
        DatasetCatalogGroup("technical_indicators", "技术指标", 14),
    ),
    items=(
